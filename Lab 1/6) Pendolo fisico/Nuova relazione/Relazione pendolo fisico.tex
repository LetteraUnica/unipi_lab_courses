...
\begin{document}
	...
	\section{Cenni teorici}
		...
		\section{Analisi dati}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.7\linewidth]{"../../../Relazione esame/Pendolo fisico parametri misurati"}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.7\linewidth]{"../../../Relazione esame/Pendolo fisico migliori parametri"}
